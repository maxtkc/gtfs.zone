...
import { FieldDescriptionsDisplay } from './modules/field-descriptions.js';
...
export class GTFSEditor {
  ...
  private init(): void {
    try {
      ...
      (this.uiController as any).initialize(this.gtfsParser, this.editor, this.mapController, this.objectsNavigation, this.validateAndUpdateInfo.bind(this));
